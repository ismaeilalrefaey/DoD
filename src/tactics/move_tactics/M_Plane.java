...
public class M_Plane extends MoveTactic {
    ...
    public void doMove( Unit unit ){
        ...
        if( unit instanceof MovableAttackerUnit )
            targetPos = ((MovableAttackerUnit)unit).getMovePlane().getTargetPos();
        else if( unit instanceof MovableUnAttackerUnit )
            targetPos = ((MovableUnAttackerUnit)unit).getMovePlane().getTargetPos();
        ...
        if( targetPos.getX() < unitPos.getX() ){
            if( targetPos.getY() < unitPos.getY() ){ // dx1
            ...
            } else if( targetPos.getY() > unitPos.getY() ){ // dx2'
        ...
        } else if( targetPos.getX() > unitPos.getX() ){
            if( targetPos.getY() < unitPos.getY() ){ // dx2
                for(int move = 0 ; move < 8 ; move++){
                    int newX = unitPos.getX() + dx2[ move ];
                    int newY = unitPos.getY() + dy2[ move ];
            ...
            } else if( targetPos.getY() > unitPos.getY() ){ // dx1'
                for(int move = 7 ; move >= 0 ; move--){
                    int newX = unitPos.getX() + dx1[ move ];
                    int newY = unitPos.getY() + dy1[ move ];
            ...
            if( targetPos.getY() < unitPos.getY() ){ // dx4
                for(int move = 0 ; move < 8 ; move++){
            ...
            } else if( targetPos.getY() > unitPos.getY() ){ // dx4'
                for(int move = 7 ; move >= 0 ; move--){
                    int newX = unitPos.getX() + dx4[ move ];
                    int newY = unitPos.getY() + dy4[ move ];
